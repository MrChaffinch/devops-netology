...
--
-- Name: orders_new; Type: TABLE; Schema: public; Owner: imarin
--
...
ALTER TABLE public.orders_new OWNER TO imarin;

--
-- Name: orders_new_id_seq; Type: SEQUENCE; Schema: public; Owner: imarin
--
...
ALTER TABLE public.orders_new_id_seq OWNER TO imarin;

--
-- Name: orders_new_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: imarin
--
...
--
-- Name: orders_1; Type: TABLE; Schema: public; Owner: imarin
--
...
ALTER TABLE public.orders_1 OWNER TO imarin;

--
-- Name: orders_2; Type: TABLE; Schema: public; Owner: imarin
--
...
ALTER TABLE public.orders_2 OWNER TO imarin;
...
--
-- Name: orders_new id; Type: DEFAULT; Schema: public; Owner: imarin
--
...
--
-- Data for Name: orders_1; Type: TABLE DATA; Schema: public; Owner: imarin
--
...
--
-- Data for Name: orders_2; Type: TABLE DATA; Schema: public; Owner: imarin
--
...
--
-- Name: orders_new_id_seq; Type: SEQUENCE SET; Schema: public; Owner: imarin
--
...
GRANT ALL ON TABLE public.orders TO imarin;
